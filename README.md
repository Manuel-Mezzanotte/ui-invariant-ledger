...
<p align="center">
  ...
  <a href="https://github.com/Manuel-Mezzanotte/ui-invariant-ledger/releases/tag/v0.1.7"><img alt="Release v0.1.7" src="https://img.shields.io/badge/release-v0.1.7-111827"></a>
...
```bash
gh skill install Manuel-Mezzanotte/ui-invariant-ledger ui-invariant-ledger@v0.1.7 --agent codex --scope user
```

Other supported agents:

```bash
gh skill install Manuel-Mezzanotte/ui-invariant-ledger ui-invariant-ledger@v0.1.7 --agent claude-code --scope user
gh skill install Manuel-Mezzanotte/ui-invariant-ledger ui-invariant-ledger@v0.1.7 --agent opencode --scope user
```
...
<p align="center">
  <img src="assets/readme-flow.png" alt="UI Invariant Ledger workflow from touched UI concerns to reviewer focus" width="100%">
</p>
